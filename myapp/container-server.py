...
def containers_remove_all():
    ...
    # Use same code as listing all containers
    containersList = docker('ps', '-a')
    allContainers = docker_ps_to_array(containersList)
...
def images_remove_all():
    ...
    #Copying code from deleting all containers
